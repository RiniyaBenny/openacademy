...
class TestSession(common.TransactionCase):
    def setUp(self):
        ...
        self.session1 = self.employee.create({'name': 'Aerospace session', 'start_date': '11/10/2020',
                                              'duration': '60.00', 'seats': '10', 'instructor_id': 'Alice',
                                              'course_id': 'Aerospace', 'attendee_ids': 'Tiya'})
        self.session2 = self.employee.create({'name': 'Aviation session', 'start_date': '12/10/2020',
